...
# En-tête de l'applilogo_base64 = get_base64_of_bin_file("./logo-ICT-group.png")
logo_html = f'<img src="data:image/png;base64,{logo_base64}" alt="Logo ICT">' if logo_base64 else '''st.markdown(f'''
